package com.ufpb.biblioteca.user.entity;
...
@Table(name = "users")
@Entity(name = "users")
public class User implements UserDetails { // A classe UserDetails vêm de Springo security e é usada para identificar uma classe
